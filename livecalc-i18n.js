...
(function () {
  ...
  var CATALOGS = {
    en: {
      ...
      'ai.error.noBaseUrl': 'Please set a Base URL in Settings.',
      ...
      'llm.error.auth': 'Authentication failed. Check API key and permissions.',
      'llm.error.notFound': 'Endpoint not found (404). Check base URL and API path.',
      ...
      'settings.llm.baseUrl.help': 'OpenAI-compatible API base URL (for example: http://localhost:1234/v1).',
      ...
      'settings.llm.apiKey.help': 'Optional for local providers.',
      'settings.llm.customRequiresApiKey': 'Custom provider requires API key',
    ...
    de: {
      ...
      'ai.error.noBaseUrl': 'Bitte eine Base-URL in den Einstellungen setzen.',
      ...
      'llm.error.auth': 'Authentifizierung fehlgeschlagen. Prüfe API-Key und Berechtigungen.',
      'llm.error.notFound': 'Endpoint nicht gefunden (404). Prüfe Base-URL und API-Pfad.',
      ...
      'settings.llm.baseUrl': 'Basis-URL',
      'settings.llm.baseUrl.help':
        'Basis-URL einer OpenAI-kompatiblen API (z. B. http://localhost:1234/v1).',
      ...
      'settings.llm.apiKey.help': 'Bei lokalen Providern optional.',
      'settings.llm.customRequiresApiKey': 'Eigener Anbieter benötigt API-Schlüssel',
